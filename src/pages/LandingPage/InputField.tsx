    ...
    <div className={className}>
      <div className="w-full bg-white rounded border border-solid border-zinc-500">
        ...
        >
          ...
          <div
            className={`flex relative flex-col flex-1 shrink justify-center items-start self-stretch my-auto basis-${trailingIcon ? "6" : "0"} min-h-10 min-w-${leadingIcon ? "60" : "0"} text-zinc-900`}
          >
            {onChange ? (
              <input
              type="text"
          ...
          {trailingIcon && (
            <div className="flex flex-col justify-center items-center self-stretch p-3 my-auto w-12 min-h-12">
              <img
                src={trailingIcon}
